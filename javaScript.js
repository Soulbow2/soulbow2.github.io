...
const one=document.getElementById("one"); const two=document.getElementById("two"); 
...
const g=document.getElementById("g"); const h=document.getElementById("h");

/* GraveYard Id's */
const whitePawn=document.getElementById("whitePawn"); const blackPawn=document.getElementById("blackPawn");
const whiteKing=document.getElementById("whiteKing"); const blackKing=document.getElementById("blackKing");
const whiteQueen=document.getElementById("whiteQueen"); const blackQueen=document.getElementById("blackQueen");
const whiteRook=document.getElementById("whiteRook"); const blackRook=document.getElementById("blackRook");
const whiteKnight=document.getElementById("whiteKnight"); const blackKnight=document.getElementById("blackKnight");
const whiteBishop=document.getElementById("whiteBishop"); const blackBishop=document.getElementById("blackBishop");

/* Tiles 1-64 */
const tile1=document.getElementById("1"); const tile2=document.getElementById("2");
const tile3=document.getElementById("3"); const tile4=document.getElementById("4");
const tile5=document.getElementById("5"); const tile6=document.getElementById("6");
const tile7=document.getElementById("7"); const tile8=document.getElementById("8");
const tile9=document.getElementById("9"); const tile10=document.getElementById("10"); 
const tile11=document.getElementById("11"); const tile12=document.getElementById("12");
const tile13=document.getElementById("13"); const tile14=document.getElementById("14");
const tile15=document.getElementById("15"); const tile16=document.getElementById("16");
const tile17=document.getElementById("17"); const tile18=document.getElementById("18");
const tile19=document.getElementById("19"); const tile20=document.getElementById("20");
const tile21=document.getElementById("21"); const tile22=document.getElementById("22");
const tile23=document.getElementById("23"); const tile24=document.getElementById("24");
const tile25=document.getElementById("25"); const tile26=document.getElementById("26");
const tile27=document.getElementById("27"); const tile28=document.getElementById("28");
const tile29=document.getElementById("29"); const tile30=document.getElementById("30");
const tile31=document.getElementById("31"); const tile32=document.getElementById("32");
const tile33=document.getElementById("33"); const tile34=document.getElementById("34");
const tile35=document.getElementById("35"); const tile36=document.getElementById("36");
const tile37=document.getElementById("37"); const tile38=document.getElementById("38");
const tile39=document.getElementById("39"); const tile40=document.getElementById("40");
const tile41=document.getElementById("41"); const tile42=document.getElementById("42");
const tile43=document.getElementById("43"); const tile44=document.getElementById("44");
const tile45=document.getElementById("45"); const tile46=document.getElementById("46");
const tile47=document.getElementById("47"); const tile48=document.getElementById("48");
const tile49=document.getElementById("49"); const tile50=document.getElementById("50");
const tile51=document.getElementById("51"); const tile52=document.getElementById("52");
const tile53=document.getElementById("53"); const tile54=document.getElementById("54");
const tile55=document.getElementById("55"); const tile56=document.getElementById("56");
const tile57=document.getElementById("57"); const tile58=document.getElementById("58");
const tile59=document.getElementById("59"); const tile60=document.getElementById("60");
const tile61=document.getElementById("61"); const tile62=document.getElementById("62");
const tile63=document.getElementById("63"); const tile64=document.getElementById("64");
...
if 
(whitePawn.style.background==="black") {
whitePawn.style.background="forestgreen";
element.innerHTML="White Pawn";
turn.innerHTML="Blacks Turn";}
else if 
(whiteKing.style.background==="black") {
whiteKing.style.background="forestgreen";
element.innerHTML="White King";
turn.innerHTML="Blacks Turn";}
else if 
(whiteQueen.style.background==="black") {
whiteQueen.style.background="forestgreen";
element.innerHTML="White Queen";
turn.innerHTML="Blacks Turn";}
else if 
(whiteRook.style.background==="black") {
whiteRook.style.background="forestgreen";
element.innerHTML="White Rook";
turn.innerHTML="Blacks Turn";}
else if
(whiteKnight.style.background==="black") {
whiteKnight.style.background="forestgreen";
element.innerHTML="White Knight";
turn.innerHTML="Blacks Turn";}
else if 
(whiteBishop.style.background==="black") {
whiteBishop.style.background="forestgreen";
element.innerHTML="White Bishop";
turn.innerHTML="Blacks Turn";}
  
else if
(blackPawn.style.background==="black") {
blackPawn.style.background="forestgreen";
...
(blackRook.style.background==="black") {
blackRook.style.background="forestgreen";
element.innerHTML="Black Rook";
turn.innerHTML="Whites Turn";}
else if 
(blackKnight.style.background==="black") {
blackKnight.style.background="forestgreen";
element.innerHTML="Black Knight";
turn.innerHTML="Whites Turn";}
else if
(blackBishop.style.background==="black") {
blackBishop.style.background="forestgreen";
...
(element.innerHTML==="Black King") {
blackKing.style.background="black";
element.innerHTML="";}
else if
(element.innerHTML==="Black Queen") {
blackQueen.style.background="black";
element.innerHTML="";}
else if 
(element.innerHTML==="Black Rook") {
...
(blackKing.style.background==="black") {
blackKing.style.background="forestgreen";
element.style.background="black";}
else if 
(blackQueen.style.background==="black") {
blackQueen.style.background="forestgreen";
element.style.background="black";}
else if 
(blackRook.style.background==="black") {
blackRook.style.background="forestgreen";
